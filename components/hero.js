            ...
            <div className="max-w-2xl mb-8">
              ...
              <div className="flex flex-col hover:opacity-95 transition-opacity items-start space-y-3 sm:space-x-4 sm:space-y-0 sm:items-center sm:flex-row">
                <a
                  ...
                  target="_blank"
                  rel="noopener"
                  className="px-4 py-2.5 text-lg font-medium text-center text-white bg-indigo-600 rounded-md "
                >
                  Quero contratar
                </a>
                <a
                  ...
                  target="_blank"
                  rel="noopener"
                  className="flex items-center space-x-2 text-gray-500 dark:text-gray-400 transition-colors hover:text-indigo-600"
                >
                  <svg
                    role="img"
      ...
      <Container>
        <div className="flex flex-col justify-center">
          <div className="text-xl text-center text-gray-700 dark:text-white">
            Utilizado por <span className="text-indigo-600">2000+</span>{" "}
            corretoras pelo Brasil
          </div>
